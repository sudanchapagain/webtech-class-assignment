                ...
                <li>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="./pages/bachelor.html">Bachelor</a>
                            <a href="./pages/masters.html">Masters</a>
                        </div>
                    </div>
                </li>
                <li><a href="./pages/admission.html">Admission</a></li>
                <li><a href="./pages/calender.html"> Calender</a></li>
            </ul>
        </div>

        <div>
            <a href="./pages/student.html"><button class="btnMain">Student Portal</button></a>
        ...
        <header>
            <div class="mainTxt">
                ...
                <div class="headButtons">
                    ...
                    <a href="./pages/about.html"><button class="btnSecondary">Learn more</button></a>
                </div>
            </div>
